...
namespace BeautySaloon.Migrations
{
    ...
    [Migration("20240602100910_UpdateScheduleAddClientAndService")]
    partial class UpdateScheduleAddClientAndService
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeautySaloon.DAL.Entity.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BeautySaloon.DAL.Entity.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("BeautySaloon.DAL.Entity.WorkScheduletEntity", b =>
                {
                    ...
                    b.HasOne("BeautySaloon.DAL.Entity.ServiceEntity", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("BeautySaloon.DAL.Entity.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("BeautySaloon.DAL.Entity.ApplicationUser", null)
                        .WithMany()
